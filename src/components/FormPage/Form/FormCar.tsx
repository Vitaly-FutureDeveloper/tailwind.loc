      ...
      >
        ...
        {({isSubmitting, setFieldValue}) => (
          ...
          <Form>
            ...
            {/* Первая часть формы */}
            <div className="grid gap-y-6 md:gap-y-4 gap-x-6 grid-cols-3 px-5 lg:px-0 sm:grid-cols-4 w-full mb-6 md:mb-5">
            ...
            <label className={styles.labelDataCar}>
              ...
              <label className="flex items-center justify-center bg-lime-400 hover:opacity-60 rounded text-center text-[10px] text-white w-full col-start-1 sm:col-start-2 col-end-4 sm:col-end-5 mt-0.5 h-7">
            ...
            {/* Вторая часть формы */}
            <div className="grid gap-y-7 md:gap-y-5 gap-x-5 md:gap-x-7 lg:gap-x-2 px-5 lg:px-0 lg:w-[385px] grid-cols-2 mb-3">
            ...
            <label className="flex relative items-start md:pt-1 mb-4 md:mb-3 px-5 lg:px-0">
              <Field className="rounded text-gray-400 border-gray-800 mr-3 md:mr-6 outline-0" type="checkbox" name="agreement"/>
