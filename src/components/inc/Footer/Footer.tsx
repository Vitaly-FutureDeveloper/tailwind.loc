...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="text-white">
      ...
      {/* FooterWrap */}
      <div
        className="flex justify-between text-center md:text-left items-center md:items-start flex-col flex-wrap md:flex-row bg-blue-950 px-16 py-8">
